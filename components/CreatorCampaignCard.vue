  ...
  <div
    ...
    <div class="flex gap-2 justify-between items-center pb-2 px-3  border-b border-b-darkBlue">
      <div class="flex items-center gap-3">
        ...
        <p class="text-ellipsis line-clamp-1"> </p>
      </div>
    ...
    <div class="flex flex-col gap-5 px-3 py-2">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="text-sm text-[#CDC2FF]">
          <p> Start Date: <span class="font-light"></span></p>
          <p> End Date: <span class="font-light"></span></p>
        </div>
      </div>
    </div>
    <!--  -->
 ...
 -->
    ...
    <div class="flex justify-between flex-col gap-2  px-2">
      <div class="flex flex-col items-start">
        <p class="uppercase font-light text-xs text-left text-gray2">total budget</p>
        <p class="uppercase font-extrabold text-2xl">$5000</p>
      </div>
      <div class="flex gap-2">
        <button class="rounded-full border-[1px] border-[#FF0000] text-red-600 bg-transparent h-fit py-1 px-4 basis-1/2">
            Reject
        </button>
        <button class="rounded-full bg-purple1 h-fit py-1 px-4 basis-1/2">
            Accept
        </button>
      </div>
    </div>
