              ...
              <SheetContent side="left">
                ...
                >
                  ...
                  <DialogTrigger>
                    ...
                    <nuxt-link to='/brands/dashboard/products' class="w-full">
                      <div class="flex items-center gap-4 cursor-pointer  hover:bg-purplebg w-full px-4  py-2 rounded hover:text-purplebg  hover:font-semibold "
                      :class="{' bg-[#674BE0] dark:bg-purplebg dark:bg-opacity-[10%] bg-opacity-[10%] text-purplebg font-semibold ': isProducts}">
                          <img src="/icons/Group.svg" class="w-8 md:w-auto" alt="">
                          <p class=" text-purplebtn dark:text-[#98A2B3]  text-nowrap text-lg lg:text-xl"> Products</p> 
                    </div>
                  </nuxt-link>
