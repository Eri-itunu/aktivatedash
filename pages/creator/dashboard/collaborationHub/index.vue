...
<template>
  <div class="">
    <div class="flex flex-col bg-grey1 text-black rounded gap-2 p-8 mb-4 " >
      ...
      <p class="font-thin">Discover small business partnerships that fit your style! Collaboration Hub connects you with unique, budget-friendly campaigns, where you get to choose the campaigns you want to join. Apply and grow with brands that value your creativity!</p>
    </div>
