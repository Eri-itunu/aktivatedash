    ...
    <div id="print-content" class="mx-4 mt-5">
      <div class="relative overflow-x-auto shadow-md rounded-lg">
        ...
        >
          ...
          >
            <tr>
              <th scope="col" class="px-6 py-3 text-center text-[#CDC2FF]">
                Campaign Name
              </th>
              <th scope="col" class="px-6 py-3 text-center text-[#CDC2FF]">
                Creators Added
              </th>
              <th scope="col" class="px-6 text-center py-3 text-[#CDC2FF]">
                Platform
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            >
              ...
              <td
                class="text-center flex gap-2 py-4 items-center justify-center"
              >
