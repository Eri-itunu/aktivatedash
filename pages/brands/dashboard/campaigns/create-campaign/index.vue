<script setup lang="ts">
    ...
    const { headline, description, requirements, platformType, contentType, fileUrl } = storeToRefs(createBrandCampaignStore);
    ...
    <div class="px-12 flex text-white flex-col py-4 gap-4">
        ...
        <form class="flex flex-col gap-5" action="">
            ...
            <div>
                ...
                <textarea v-model="description" class="border-[0.5px] p-2 rounded-md w-full bg-transparent" name="" id="" cols="30" rows="5" ></textarea>
            </div>

            <div>
                <p class="text-[#E1DCF7]">Campaign Requirements</p>
                <textarea v-model="requirements" class="border-[0.5px] p-2 rounded-md w-full bg-transparent" name="" id="" cols="30" rows="5" ></textarea>
            </div>
